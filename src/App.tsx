  ...
  return (
    <div className="w-full lg:w-1/4 md:w-1/3 rounded-xl m-[auto] m-4 p-8 bg-white flex flex-col items-center justify-center ">
      ...
      <div className="flex flex-row">
        <Button
          onClick={() => addNumbers(firstInput, secondInput)}
          operant="+"
        />
        <Button
          onClick={() => subtractNumbers(firstInput, secondInput)}
          operant="-"
        />
        <Button
          onClick={() => multiplyNumbers(firstInput, secondInput)}
          operant="x"
        />
        <Button
          onClick={() => divideNumbers(firstInput, secondInput)}
          operant="/"
        />
      </div>
